      ...
      {isLoggedIn && (
        <>
          <div class="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 p-4 gap-4">
            ...
            {teams.map((team)=>(
              <div onClick={()=>setCategory(team.TeamId._id)} class="bg-emerald-900 dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-emerald-1000 dark:border-gray-600 text-white font-medium group">
